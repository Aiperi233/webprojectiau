...
<title>IAU Library Management System</title>
...
<tr><td class="labels">Full Name : </td><td><input type="text" name="name" class="fields" placeholder="Enter Full name" required="required" size="25" /></td></tr>
...
<tr><td class="labels">Semestr : </td>
<td>
<select name="sem" class="fields" required>
<option value="" disabled="disabled" selected="selected">- - Select Semestr - -</option>
...
<tr><td class="labels">Faculty : </td>
<td>
<select name="branch" class="fields" required>
<option value="" disabled="disabled" selected="selected">- - Select Faculty - -</option>
<option value="Faculty of Engineering and Computer Science">Faculty of Engineering and Computer Science</option>
<option value="Faculty of Humanities">Faculty of Humanities</option>
<option value="Faculty of Economics and Management">Faculty of Economics and Management</option>
...
<tr><td class="labels">Password : </td><td><input type="password" name="pass" class="fields" placeholder="Enter your Password" required="required" size="25" /></td></tr>
