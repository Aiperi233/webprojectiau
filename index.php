...
<span class="SubHead">Sign in as a Student</span>
<br />
<br />
...
<tr><td class="labels">Password : </td><td><input type="password" name="pass" class="fields" size="25" placeholder="Enter your password" required="required" /></td></tr>
<tr><td colspan="2" align="center"><input type="submit" value="Sign In" class="fields" /></td></tr>
</table>
</form>
<br />
<br />
<a href="register.php" class="link">Register If you don't have account</a>
<br />
<a href="admin.php" class="link">Sign in as Admin</a>
